...
return new class extends Migration
{
    ...
    public function up(): void{
        Schema::create('person_enactment_main_commission', function (Blueprint $table) {
            $table->comment('کمیسیون های اصلی لایحه');
    ...
    {
        Schema::dropIfExists('person_enactment_main_commission');
    }
};

...
return new class extends Migration
{
    ...
    {
        Schema::create('person_deputy_governor_media_actions', function (Blueprint $table) {
            $table->comment('اقدامات نشست رسانه ای');
            $table->id('row_id');
    ...
    {
        Schema::dropIfExists('person_deputy_governor_media_actions');
    }
};

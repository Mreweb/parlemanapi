...
return new class extends Migration
{
    ...
    {
        Schema::create('person_plan_promote_law', function (Blueprint $table) {
            $table->comment('ابلاغ قانون');
            $table->id('row_id')->autoIncrement();
            $table->longText('plan_detail')->comment('داده های جیسون ابلاغ قانون');
    ...
    {
        Schema::dropIfExists('person_plan_promote_law');
    }
};

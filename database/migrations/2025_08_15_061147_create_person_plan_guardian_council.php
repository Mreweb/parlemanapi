...
return new class extends Migration
{
    ...
    {
        Schema::create('person_plan_guardian_council', function (Blueprint $table) {
            $table->comment('ابلاغ مصوبه به شورای نگهبان');
            $table->id('row_id')->autoIncrement();
            $table->longText('plan_detail')->comment('داده های جیسون ابلغ مصوبه به شورای نگهبان');
    ...
    {
        Schema::dropIfExists('person_plan_guardian_council');
    }
};

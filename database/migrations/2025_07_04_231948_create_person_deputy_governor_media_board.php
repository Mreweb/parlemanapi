...
return new class extends Migration
{
    ...
    {
        Schema::create('person_deputy_governor_media_board', function (Blueprint $table) {
            $table->comment('افراد حاضر در نشست های رسانه ای');
            $table->id('row_id');
    ...
    {
        Schema::dropIfExists('person_deputy_governor_media_board');
    }
};

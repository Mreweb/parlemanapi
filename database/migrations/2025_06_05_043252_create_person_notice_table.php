...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('person_notice', function (Blueprint $table) {
            ...
            $table->string('person_id')->comment('شخصی که تذکر دهنده بوده')->nullable();
            $table->string('president_id')->comment('در کدام شخص ریاست جمهوری تذکر داده شده')->nullable();
            $table->string('gov_period_id')->comment('در کدام دوره دولت')->nullable();
            $table->string('parliament_period_id')->comment('در کدام دوره مجلس')->nullable();

...
return new class extends Migration
{
    ...
    {
        Schema::create('person_plan_main_commission', function (Blueprint $table) {
            $table->comment('کمیسیون های اصلی طرح');
    ...
    {
        Schema::dropIfExists('table_person_plan_main_commission');
    }
};

...
class PlanRepository implements IPlanRepository{
    ...
    public function findById(int $id){
        ...
        $result[0]['attachments'] = (new UploadRepository())->get_attachments($result[0]['plan_id'], (new PlanEloquent()->getTable()));
    ...
    public function create(array $data)
    {
        ...
        return DB::transaction(function () use ($data) {
            ...
            (new UploadRepository())->add_attachments($attachments, (new PlanEloquent()->getTable()), $result->plan_id);
    ...
    public function update(array $data)
    {
        ...
        return DB::transaction(function () use ($data) {
            ...
            (new UploadRepository())->add_attachments($attachments, (new PlanEloquent()->getTable()), $data['plan_id']);

...
namespace App\Http\Controllers\Common\Country;

use App\Application\Services\Common\Country\ProvinceService;
use App\Application\Services\Utility\DBMessageService;
use App\Http\Controllers\Controller;
use App\Http\Requests\Common\Country\Province\ProvinceRequest;
use App\Http\Requests\Common\Country\Province\ProvinceUpdateRequest;
...
class ProvinceController extends Controller{
    ...
    /**
     * @lrd:start
     * ویرایش استان - فهرست شهر ها بصورت آرایه دریافت گردد
     * [1,2,3,4]
     * @lrd:end
     */
